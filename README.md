...
vcf package install cluster-autoscaler-pkg -n tkg-system --package cluster-autoscaler.kubernetes.vmware.com --version 1.33.0+vmware.1-vks.1 --values-file ./values.yaml
